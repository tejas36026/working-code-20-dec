self.onmessage = function(e) {
    ...
    //         { leftUpperArmAngle: 0, leftLowerArmAngle: 0, rightUpperArmAngle: 0, rightLowerArmAngle: 0, leftUpperLegAngle: -45, leftLowerLegAngle: -30, rightUpperLegAngle: 0, rightLowerLegAngle: 0 },  // Raised and bent back
    //         { leftUpperArmAngle: 0, leftLowerArmAngle: 0, rightUpperArmAngle: 0, rightLowerArmAngle: 0, leftUpperLegAngle: 45, leftLowerLegAngle: 30, rightUpperLegAngle: 0, rightLowerLegAngle: 0 },    // Lowered and bent forward
    //         { leftUpperArmAngle: 0, leftLowerArmAngle: 0, rightUpperArmAngle: 0, rightLowerArmAngle: 0, leftUpperLegAngle: 0, leftLowerLegAngle: -90, rightUpperLegAngle: 0, rightLowerLegAngle: 0 },    // Straight out with bent elbow
    //         { leftUpperArmAngle: 0, leftLowerArmAngle: 0, rightUpperArmAngle: 0, rightLowerArmAngle: 0, leftUpperLegAngle: -90, leftLowerLegAngle: 0, rightUpperLegAngle: 0, rightLowerLegAngle: 0 }     // Raised straight up
    //     ];
        ...
        const generateMovements = (count) => {
            ...
            for (let i = 0; i < count; i++) {
                ...
                const movement = {
                    ...
                    leftUpperLegAngle: i === 0 ? 0 : (i % 2 === 0 ? -angleStep * (i / 2) : angleStep * ((i + 1) / 2)),
                    leftLowerLegAngle: i === 0 ? 0 : (i % 2 === 0 ? -angleStep * (i / 2) : angleStep * ((i + 1) / 2)),
