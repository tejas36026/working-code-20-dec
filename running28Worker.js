self.onmessage = function(e) {
    ...
    const cycleLength = 7; // Number of frames in the lunge cycle
    const phase = (t * cycleLength) % 1; // Current phase of the lunge cycle
    const forwardLunge = 0.1 * Math.sin(phase * Math.PI * 2); // Forward lunge effect
    const downwardLunge = 0.1 * Math.cos(phase * Math.PI * 2); // Downward lunge effect
