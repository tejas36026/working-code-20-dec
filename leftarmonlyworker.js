self.onmessage = function(e) {
    ...
    console.log("left worekr cdeo only ");
    ...
    if (type === 'combinedResults') {
        ...
        const generateMovements = (count) => {
            ...
            for (let i = 0; i < count; i++) {
                ...
                const movement = {
                    leftUpperArmAngle: i === 0 ? 0 : (i % 2 === 0 ? -angleStep * (i / 2) : angleStep * ((i + 1) / 2)),
                    leftLowerArmAngle: i === 0 ? 0 : (i % 2 === 0 ? -angleStep * (i / 2) : angleStep * ((i + 1) / 2)),
